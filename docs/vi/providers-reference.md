# Tài liệu tham khảo Providers — MultiClaw
...
3. Biến môi trường dự phòng chung: `MULTICLAW_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, MultiClaw gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, MultiClaw trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `multiclaw models refresh --provider nvidia`
