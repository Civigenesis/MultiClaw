...
Cách cài đặt và khởi tạo MultiClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài MultiClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image MultiClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.multiclaw-docker`.
