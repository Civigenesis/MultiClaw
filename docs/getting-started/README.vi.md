...
| Tình huống | Lệnh |
|----------|---------|
| Có API key, muốn cài nhanh nhất | `multiclaw onboard --api-key sk-... --provider openrouter` |
| Muốn được hướng dẫn từng bước | `multiclaw onboard --interactive` |
| Đã có config, chỉ cần sửa kênh | `multiclaw onboard --channels-only` |
...
- Thiết lập nhanh: `multiclaw onboard --api-key "sk-..." --provider openrouter`
- Thiết lập tương tác: `multiclaw onboard --interactive`
- Kiểm tra môi trường: `multiclaw status` + `multiclaw doctor`
