...
```bash
# Check config
cat ~/.multiclaw/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time multiclaw channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   multiclaw daemon
   # or
   RUST_LOG=info multiclaw channel start
   ```
...
- Issues: https://github.com/Civigenesis/MultiClaw/issues
