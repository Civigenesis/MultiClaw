//! # MultiClaw Robot Kit
//!
//! A standalone robotics toolkit that integrates with MultiClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  MultiClaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use multiclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of MultiClaw. It defines its own
//! `Tool` trait that is compatible with MultiClaw's but doesn't require it.
//!
//! ## Safety
//!
