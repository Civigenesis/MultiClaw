...
use multiclaw::providers::compatible::AuthStyle;
use multiclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use multiclaw::providers::compatible::OpenAiCompatibleProvider;
