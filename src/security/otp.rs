...
const OTP_ISSUER: &str = "MultiClaw";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(multiclaw_dir);
...
pub fn secret_file_path(multiclaw_dir: &Path) -> PathBuf {
    multiclaw_dir.join(OTP_SECRET_FILE)
}
