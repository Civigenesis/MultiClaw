...
/// Handle `multiclaw peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: multiclaw peripheral add <board> <path>");
                println!("  Example: multiclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
