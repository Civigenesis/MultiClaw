...
Options:
    ...
    --repo OWNER/NAME   Repository (default: Civigenesis/MultiClaw)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="Civigenesis/MultiClaw",
        help="Repository in OWNER/NAME format (default: Civigenesis/MultiClaw)",
    )
