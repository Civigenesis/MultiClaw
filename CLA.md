# MultiClaw Contributor License Agreement (CLA)
...
property rights granted by contributors to MultiClaw Labs. This agreement
protects both contributors and users of the MultiClaw project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the MultiClaw repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to MultiClaw Labs
  for inclusion in the MultiClaw project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"MultiClaw Labs"** means the maintainers and organization responsible
  for the MultiClaw project at https://github.com/Civigenesis/MultiClaw.

---

## 2. Grant of Copyright License

You grant MultiClaw Labs and recipients of software distributed by MultiClaw
...
the MultiClaw project.

**This protects you:** if a third party files a patent claim against
MultiClaw that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to MultiClaw
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with MultiClaw Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the MultiClaw name,
...
MultiClaw Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the MultiClaw project are licensed under
both:
...
By opening a pull request or submitting a patch to the MultiClaw repository,
...
https://github.com/Civigenesis/MultiClaw/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the MultiClaw dual-license model.*
