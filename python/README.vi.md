...
Gói Python đồng hành cho [MultiClaw](https://github.com/Civigenesis/MultiClaw) — gọi công cụ dựa trên LangGraph cho thực thi agent LLM nhất quán.
...
## So sánh với Rust MultiClaw

| Tính năng | Rust MultiClaw | multiclaw-tools |
|---------|---------------|----------------|
...
Dùng **Rust MultiClaw** cho triển khai biên (edge) trong sản phẩm. Dùng **multiclaw-tools** khi cần đảm bảo tính nhất quán gọi công cụ hoặc tích hợp hệ sinh thái Python.
