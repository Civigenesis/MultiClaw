# MultiClaw Trademark Policy

**Effective date:** February 2026  
**Maintained by:** Civigenesis

---

## Our Trademarks

The following are trademarks of Civigenesis:

- **MultiClaw** (word mark)
- The MultiClaw logo and associated visual identity

These marks identify the official MultiClaw project and distinguish it from
...
The **only** official MultiClaw repository is:

> https://github.com/Civigenesis/MultiClaw

Any other repository, organization, domain, or product claiming to be
"MultiClaw" or implying affiliation with Civigenesis is unauthorized and
may constitute trademark infringement.

**Known unauthorized forks:**
- `openagen/multiclaw` — not affiliated with Civigenesis

If you encounter an unauthorized use, please report it by opening an issue
at https://github.com/Civigenesis/MultiClaw/issues.

---

## Permitted Uses

You **may** use the MultiClaw name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   MultiClaw, provided it is clear your project is not the official MultiClaw.

2. **Descriptive reference** — referring to MultiClaw in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of MultiClaw"
...
You **may not** use the MultiClaw name or marks in ways that:

1. **Imply official endorsement** — suggest your project, product, or
   organization is officially affiliated with or endorsed by Civigenesis.

2. **Cause brand confusion** — use "MultiClaw" as the primary name of a
...
3. **Impersonate the project** — create repositories, domains, packages,
   or accounts that could be mistaken for the official MultiClaw project.

4. **Misrepresent origin** — remove or obscure attribution to Civigenesis
   while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products,
   services, or marketing without prior written permission from Civigenesis.
...
you fork MultiClaw, you must:

- Clearly state your project is a fork of MultiClaw
- Link back to the official repository
- Not use "MultiClaw" as the primary name of your fork
...
Contributors to the official MultiClaw repository are protected under the
...
If you believe someone is infringing MultiClaw trademarks:

1. Open an issue at https://github.com/Civigenesis/MultiClaw/issues
...
Civigenesis reserves the right to update this policy at any time. Changes
...
this policy governs use of the MultiClaw name and brand.*
